...
const eatPlays = new Turn(new Board(EAT_BOARD), WHITE, true);

const travelPlays = new Turn(new Board(CLASSIC_BOARD), WHITE, true);

const tonePawnPlays = new Turn(new Board(ONE_WHITE_PAWN_BOARD), WHITE, true);
...
methodTest(eatPlays.makePlay, () => {
  it('should return newSituation.getPlayerTurn=BLACK if white player make a travel play ', () => {
    const initialPlaySituation = new Turn(
